BEGIN {
     ...
     description = "TA_HW_33__script_33_01"
...
#if browser.link(:id => "id_link_rubygems").exists?
if browser.link(:text => "rubygems.org::output-to-file").exists?
  puts "Test Case TC-01-36-03: Rubygems Link verification (none) - Failed!"
else
puts "Test Case TC-01-36-03: Rubygems Link verification (none) - Passed!"
end
