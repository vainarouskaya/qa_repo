...
#Display the first item of this array
puts "First item of array 'days' is: #{days.first}"
#Display the last item of this array
puts " Last item of array 'days' is: #{days.last}"
#Display this array in reverse order
puts "The array 'days' in reverse order is: #{days.reverse}"
#Display this array in shuffle order
puts "The array 'days' in shuffle order is: #{days.shuffle}"
#Verify if this array is contains # 15?
puts "If array 'days' contains # 15: #{ days.include?15}"
#Verify if this array is contains # 32?
puts "If array 'days' contains # 32: #{ days.include? 32}"
#Convert this array in to string and display it
puts days.to_s.class
#Remove all elements from this array
puts "Removing all elements from array 'days': #{days = []}"